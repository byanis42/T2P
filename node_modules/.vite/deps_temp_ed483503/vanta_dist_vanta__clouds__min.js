  ...
  "node_modules/vanta/dist/vanta.clouds.min.js"(exports, module) {
    !function(e, t) {
      ...
      return function(e) {
        ...
        const o = (e2) => e2[Math.floor(Math.random() * e2.length)];
        function s(e2, t2) {
          return null == e2 && (e2 = 0), null == t2 && (t2 = 1), e2 + Math.random() * (t2 - e2);
        }
        function r(e2, t2) {
          return null == e2 && (e2 = 0), null == t2 && (t2 = 1), Math.floor(e2 + Math.random() * (t2 - e2 + 1));
        }
        const a = (e2) => document.querySelector(e2), h = (e2) => "number" == typeof e2 ? "#" + ("00000" + e2.toString(16)).slice(-6) : e2, c = (e2, t2 = 1) => {
        ...
        function l(e2) {
          for (; e2.children && e2.children.length > 0; )
            l(e2.children[0]), e2.remove(e2.children[0]);
        ...
        r.register = (e2, t2) => r[e2] = (e3) => new t2(e3), r.version = "0.5.22";
        const a = function() {
        ...
        r.VantaBase = class {
          constructor(e2 = {}) {
            ...
            try {
              ...
              return a("Init error", e3), this.renderer && this.renderer.domElement && this.el.removeChild(this.renderer.domElement), void (this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = Object(i.b)(this.options.backgroundColor)));
            }
          ...
          triggerMouseMove(e2, t2) {
            ...
            "function" == typeof this.onMouseMove && this.onMouseMove(n2, i2);
          }
          setSize() {
          ...
          destroy() {
            ...
            const t2 = this.scene;
            t2 && t2.children && Object(i.a)(t2), this.renderer && (this.renderer.domElement && this.el.removeChild(this.renderer.domElement), this.renderer = null, this.scene = null), r.current === this && (r.current = null);
          }
        }, t.b = r.VantaBase;
      }, function(e, t, n) {
        "use strict";
        ...
        class s extends i.b {
          constructor(e2) {
            o = e2.THREE || o, o.Color.prototype.toVector = function() {
              return new o.Vector3(this.r, this.g, this.b);
            }, super(e2), this.updateUniforms = this.updateUniforms.bind(this);
          }
          init() {
            this.mode = "shader", this.uniforms = { iTime: { type: "f", value: 1 }, iResolution: { type: "v2", value: new o.Vector2(1, 1) }, iDpr: { type: "f", value: window.devicePixelRatio || 1 }, iMouse: { type: "v2", value: new o.Vector2(this.mouseX || 0, this.mouseY || 0) } }, super.init(), this.fragmentShader && this.initBasicShader();
          }
          setOptions(e2) {
          ...
          initBasicShader(e2 = this.fragmentShader, t2 = this.vertexShader) {
            ...
            const n2 = new o.ShaderMaterial({ uniforms: this.uniforms, vertexShader: t2, fragmentShader: e2 }), i2 = this.options.texturePath;
            i2 && (this.uniforms.iTex = { type: "t", value: new o.TextureLoader().load(i2) });
            const s2 = new o.Mesh(new o.PlaneGeometry(2, 2), n2);
            this.scene.add(s2), this.camera = new o.Camera(), this.camera.position.z = 1;
          }
          updateUniforms() {
            const e2 = {};
            let t2, n2;
            for (t2 in this.options)
              n2 = this.options[t2], -1 !== t2.toLowerCase().indexOf("color") ? e2[t2] = { type: "v3", value: new o.Color(n2).toVector() } : "number" == typeof n2 && (e2[t2] = { type: "f", value: n2 });
